...
def parse_args():
    ...
    parser.add_argument('--feats_dim', type=int, default=96, help='output feature dimension')
...
def eval(epoch, args, test_areas = ['Area_5']):
    ...
    # # model.load_state_dict(torch.load('/home/zihui/SSD2/GrowSP/ckpt/S3DIS/model_1270_checkpoint.pth'))
