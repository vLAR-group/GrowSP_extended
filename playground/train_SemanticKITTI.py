...
from utils_degrowsp import get_pseudo_kitti, get_fixclassifier, get_sp_feature_unScenes
...
def parse_args():
    ...
    ###
    parser.add_argument('--save_path', type=str, default='ckpt_seg/SemanticKITTI/primitive_grow/80-20_0.9',
                        help='model savepath')
    parser.add_argument('--max_epoch', type=list, default=200, help='max epoch for non-growing and growing stage')
    parser.add_argument('--max_iter', type=list, default=200*300, help='max iter for non-growing and growing stage')
    ###
    ...
    parser.add_argument('--log-interval', type=int, default=300, help='log interval')
...
def main(args, logger):
    ...
    model.load_state_dict(torch.load('./ckpt_distill/nuScenes/nuscenes_dinov2_distill_change_head/cmd/model_200_checkpoint.pth'))
    ...
    distill_model.load_state_dict(torch.load('./ckpt_distill/nuScenes/nuscenes_dinov2_distill_change_head/cmd/model_200_checkpoint.pth'))
    distill_model.eval()
