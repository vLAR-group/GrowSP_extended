...
def vis_preds(args, model_path, cls_path):
    ...
    for data in val_loader:
        with torch.no_grad():
            coords, features, inverse_map, voxel_label, index, pc, labels = data
...
if __name__ == '__main__':
    args = parse_args()
    model_path = 'ckpt/nuScenes/seg/model_20_checkpoint.pth'
    cls_path = 'ckpt/nuScenes/seg/cls_20_checkpoint.pth'
