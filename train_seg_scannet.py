...
def parse_args():
    ...
    parser.add_argument('--sp_path', type=str, default='data/ScanNet/initial_superpoints2',
                        help='initial sp path')
    parser.add_argument('--save_path', type=str, default='ckpt_seg/ScanNet',
                        help='model savepath')
    ...
    parser.add_argument('--log-interval', type=int, default=120, help='log interval')
    ...
    parser.add_argument('--primitive_endnum', type=int, default=30, help='the end number of primitives')
    parser.add_argument('--start_sp', type=int, default=80)
    parser.add_argument('--end_sp', type=int, default=30)
    parser.add_argument('--distill_ckpt', type=str, default='ckpt_distill/ScanNet/checkpoint_300.tar')
...
def main(args, logger):
    ...
    for epoch in range(1, args.max_epoch + 1):
        ...
        train(train_loader, logger, model, optimizer, loss, epoch, classifier)
...
def cluster(args, logger, cluster_loader, current_sp, model):
    ...
    classifier = get_fixclassifier(in_channel=args.feats_dim, centroids_num=args.primitive_num,
...
def train(train_loader, logger, model, optimizer, loss_func, epoch, classifier):
    model.train()
    classifier.train()
    loss_display = 0
    time_curr = time.time()
